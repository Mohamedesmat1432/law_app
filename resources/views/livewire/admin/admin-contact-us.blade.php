@section('title', 'admin contact-us page')
<div>
    @include('livewire.admin.create-admin-contact-us')
    @include('livewire.admin.update-admin-contact-us')
    ...
    <div class="container py-5 text-right">
        <div class="row">
            <div class="col-md-12">
                ...
                <hr>
                <input type="text" class="form-control my-3" placeholder="ابحث عن العميل ..." wire:model="seachItem"
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#updateContact" wire:click.prevent="edit({{ $contact->id }})">
                                        {{-- تعديل --}}
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="confirm('هل انت متأكد من حذف هذا العميل ؟') || event.stopImmediatePropagation()"
                                        wire:click.prevent="delete({{ $contact->id }})">
                                        {{-- حذف --}}
