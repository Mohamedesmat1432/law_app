...
<div>
    @include('livewire.admin.create-admin-post')
    @include('livewire.admin.update-admin-post')
    <div class="container py-5 text-right">
        <div class="row">
            <div class="col-md-12">
                ...
                <hr>
                <input type="text" class="form-control my-3" placeholder="ابحث عن المنشور ..." wire:model="seachItem"
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#updatePost" wire:click.prevent="edit({{ $post->id }})">
                                        {{-- تعديل --}}
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="confirm('هل انت متأكد من حذف هذا المنشور ؟') || event.stopImmediatePropagation()"
