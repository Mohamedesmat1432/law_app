...
<div>
    @include('livewire.admin.create-admin-user')
    @include('livewire.admin.update-admin-user')
    ...
    <div class="container py-5 text-right">
        <div class="row">
            <div class="col-md-12">
                ...
                <hr>
                {{-- <input type="text"  class="form-control my-3" placeholder="ابحث عن العميل ..." wire:model="seachItem" autofocus autocomplete /> --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#updateUser" wire:click.prevent="edit({{ $user->id }})">
                                        {{-- تعديل --}}
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="confirm('هل انت متأكد من حذف هذا المستخدم ؟') || event.stopImmediatePropagation()"
