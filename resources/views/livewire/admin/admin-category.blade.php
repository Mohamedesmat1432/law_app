...
<div>
    @include('livewire.admin.update-admin-category')
    @include('livewire.admin.create-admin-category')
    <div class="container py-5 text-right">
        <div class="row">
            <div class="col-md-12">
                ...
                <hr>
                <input type="text" class="form-control my-3" placeholder="ابحث عن القسم ..." wire:model="seachItem"
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#updateCategory" wire:click.prevent="edit({{ $category->id }})">
                                        {{-- تعديل --}}
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="confirm('هل انت متأكد من حذف هذا القسم ؟') || event.stopImmediatePropagation()"
